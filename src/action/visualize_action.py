...
def visualize_joint_pose(data, ax, muscle=None):
    ...
    leftlinestyle = {'color':'blue',
            'linewidth':3,
            'markersize':12}
    
    rightlinestyle = {'color':'green',
        'linewidth':3,
        'markersize':12}
    # [4, 4, 7, 3, 4, 3, 3]
    ...
    ax.scatter3D(data[:,0], data[:,1], data[:,2], color='red', s=28)
    # ax.scatter3D(shoulders[:,0], shoulders[:,1], shoulders[:,2], color='orange', s=28)
