...
class TactileEncoder(nn.Module):
    def __init__(self, latent_dim=128, input_dim=32, use_conv=True):
        super().__init__()
...
class VPoserEncoder(nn.Module):
    def __init__(self, hidden_dim=128, latent_dim=128, type='hand'):
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        self.handpose = VPoserEncoder(latent_dim=embed_dim)
    ...
    def encode_handpose(self, handpose):
        pass
