...
def parse_args():
    ...
    parser.add_argument('--video-model', type=str, default='avdc', choices=['aa', 'i2vgen', 'i2vgen-xl', 'avdc', 'i2vgen-avdc', 'sd', 'sd-avdc', 'ours', 'our', 'ours-lcd', 'ours-lcd-ll', 'our-lcd', 'our-lcd-ll', 'ours-i2v', 'our-i2v'])
    ...
    parser.add_argument('--eval-freq', type=float, default=0.5)
    ...
    video_model_cfg['our']['unet-lcd-ll']['image_model_choice'] = args.lcd_ctx_model
