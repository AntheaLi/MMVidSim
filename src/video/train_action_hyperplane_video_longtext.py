...
from data import ActionSenseVideoLongDescription
from models.model_hyperplane_trainer import Trainer
from models.model_video_hyperplane_wtext import VideoDiffusion, Network
...
if __name__ == '__main__':
    ...
    # signals = ['right-hand-pose', 'left-hand-pose', 'myo-emg-left', 'myo-emg-right', 'joint-position']
    # signals = ['tactile-glove-left', 'tactile-glove-right', 'myo-emg-left', 'myo-emg-right', 'joint-position']
    # signals = ['tactile-glove-left', 'tactile-glove-right', 'right-hand-pose', 'left-hand-pose', 'myo-emg-left', 'myo-emg-right']
    # signals = ['tactile-glove-left', 'tactile-glove-right', 'right-hand-pose', 'left-hand-pose', 'joint-position']
    # signals = ['tactile-glove-left', 'tactile-glove-right', 'right-hand-pose', 'left-hand-pose']
    # signals = ['right-hand-pose', 'left-hand-pose', 'joint-position']
    # signals = ['right-hand-pose', 'left-hand-pose']
    # signals = ['tactile-glove-left', 'tactile-glove-right']
    # signals = ['joint-position']
    # signals = ['myo-emg-left', 'myo-emg-right']
    
    
    
    train_dataset = ActionSenseVideoLongDescription(path=args.data_path, split='train', parse_signal_keys=signals, resample_len=args.data_resample_len, video_res=args.image_size)

    val_dataset = ActionSenseVideoLongDescription(path=args.data_path, split='val', parse_signal_keys=signals, resample_len=args.data_resample_len, video_res=args.image_size)
