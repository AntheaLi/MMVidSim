...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        valid_dl = DataLoader(self.valid_ds, batch_size=valid_batch_size, shuffle=False, pin_memory=True, num_workers=args.num_workers)
        ...
        self.model, self.opt, dl, self.valid_dl = self.accelerator.prepare(diffusion_model, optimizer, dl, valid_dl)
        self.dl = cycle(dl)
