...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        assert model_type in ['avdc', 'i2vgen', 'i2vgen-avdc', 'our', 'ours', 'ours-lcd', 'our-lcd'], f'{model_type} not implemented'
            ...
            while self.step < self.train_num_steps:
                ...
                for _ in range(self.gradient_accumulate_every):
                    ...
                    with self.accelerator.autocast():
                        ...
                        loss, model_pred = self.model(x, goal_embed, text_feature, negative_task_emb=negative_embed)
