...
class I2VGenUNetTiny(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    r"""
    ...
    def __init__(
        ...
        block_out_channels: Tuple[int, ...] = (8, 32, 64, 64),
        ...
        time_embed_dim = block_out_channels[0] * in_channels
    ...
    def forward(
        ...
        context_emb = sample.new_zeros(batch_size, 0, self.cross_attention_dim)
        ...
        image_emb = image_emb.view(-1, self.in_channels, self.cross_attention_dim)
