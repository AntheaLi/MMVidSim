...
from models.modules.sd.attention import SpatialTransformer
from models.modules.sd.diffusionmodules.util import (avg_pool_nd, conv_nd, linear,
                                              normalization,
                                              timestep_embedding, zero_module)
from models.modules.sd.video_attention import SpatialVideoTransformer
from models.modules.sd.utils import exists
...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(
        ...
        from models.modules.sd.diffusionmodules.video_model import VideoResBlock
