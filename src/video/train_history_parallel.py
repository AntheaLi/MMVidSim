...
from models.model_hyperplane_history_trainer_parallel import Trainer
from models.model_history_hyperplane_parallel import VideoDiffusion, Network
...
if __name__ == '__main__':
    ...
    os.makedirs(os.path.join(exp_dir, 'visu'), exist_ok=True)
